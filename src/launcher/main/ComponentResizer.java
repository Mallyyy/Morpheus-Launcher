...
public class ComponentResizer extends MouseAdapter
{
  ...
  {
    cursors.put(1, Cursor.DEFAULT_CURSOR);
    cursors.put(2, Cursor.DEFAULT_CURSOR);
    cursors.put(4, Cursor.DEFAULT_CURSOR);
    cursors.put(8, Cursor.DEFAULT_CURSOR);
    cursors.put(3, Cursor.DEFAULT_CURSOR);
    cursors.put(9, Cursor.DEFAULT_CURSOR);
    cursors.put(6, Cursor.DEFAULT_CURSOR);
    cursors.put(12, Cursor.DEFAULT_CURSOR);
  }
